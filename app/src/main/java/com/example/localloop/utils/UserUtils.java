                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        if (role.equals("ADMIN")){
                           user = new Admin(firstName,lastName,userName,email);
                        }
                        else if (role.equals("PARTICIPANT")){
                            user = new Participant(firstName,lastName,userName,email);

                        } else if (role.equals("ORGANIZER")){
                            user = new Organizer(firstName,lastName,userName,email);
                        }
                        if (user != null){
